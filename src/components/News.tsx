    ...
    <section id="noticias" className="py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <span className="text-[#d4af37] font-semibold text-sm uppercase tracking-wider">Atualidades</span>
          ...
          {newsItems.map((item, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="font-bold text-[#1a1a2e] text-lg mb-2 group-hover:text-[#d4af37] transition-colors line-clamp-2">
                  {item.title}
                </h3>
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#1a1a2e] text-white rounded-lg font-medium hover:bg-[#16213e] transition-colors"
          >
