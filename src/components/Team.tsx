...
export default function Team() {
  return (
    <section id="equipe" className="py-20 md:py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center mb-16">
          <span className="text-[#d4af37] font-semibold text-sm uppercase tracking-wider">Nossa Equipe</span>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {coordinators.map((person, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-6 border border-gray-100 hover:border-[#d4af37]/30 transition-all card-shadow-hover text-center group"
            >
              <div className="w-20 h-20 rounded-full bg-[#1a1a2e] flex items-center justify-center mx-auto mb-4 group-hover:bg-[#d4af37] transition-colors">
                <span className="text-[#d4af37] font-bold text-xl group-hover:text-[#1a1a2e] transition-colors">
                  {person.initials}
                </span>
              </div>
              <h3 className="font-bold text-[#1a1a2e] text-base mb-1">{person.name}</h3>
              <span className="text-[#d4af37] text-xs font-semibold uppercase tracking-wider">{person.role}</span>
        ...
        {/* Members info */}
        <div className="bg-white rounded-2xl p-8 md:p-10 border border-gray-100 mb-12">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div>
              <h3 className="font-bold text-[#1a1a2e] text-lg">Integrantes do Grupo</h3>
        ...
        <div className="text-center mb-8">
          <h3 className="text-xl font-bold text-[#1a1a2e]">Cooperação Internacional</h3>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          {internationalPartners.map((partner, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-5 border border-gray-100 text-center hover:border-[#d4af37]/30 transition-colors"
            >
